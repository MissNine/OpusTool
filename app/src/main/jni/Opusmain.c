...
jint Java_com_ione_opustool_OpusJni_Opusopen(JNIEnv *env, jobject thiz, jint compression) {
...
JNIEXPORT
jint Java_com_ione_opustool_OpusJni_OpusgetFrameSize(JNIEnv *env, jobject thiz) {
    return FRAME_SIZE;
}
//压缩
JNIEXPORT
jint
Java_com_ione_opustool_OpusJni_Opusencode(JNIEnv *env, jobject thiz, jshortArray lin, jint offset,
...
//解压
JNIEXPORT
jint Java_com_ione_opustool_OpusJni_Opusdecode(JNIEnv *env, jobject thiz,
...
//释放语音对象
JNIEXPORT
void Java_com_ione_opustool_OpusJni_Opusclose(JNIEnv *env, jobject thiz) {
...
void Java_com_ione_opustool_OpusJni_OpusEncode() {
